...
const TicketReport = () => {
    ...
    return currencies.map((currency) => {
      ...
      return (
        ...
        >
          ...
          {currency.currencyId === CurrencyId.VES && showVesTicketReport && (
            <TicketReportTable
              key={currency.currencyId}
  ...
  }, [currencies, selectedTab, ticketReportUsdState, ticketReportVesState, isTicketDetailLoading, setTicketReportParams]);

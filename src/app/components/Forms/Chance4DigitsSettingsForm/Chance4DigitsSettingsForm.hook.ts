...
export const useChance4DigitsSettingsForm = (
  ...
  const settingAnimalitosSchema = Yup.object().shape({
    ...
    minDigitsByBet: Yup.number()
      ...
      .required(`${getChance4DigitsSettingsLabel('maxDigitsByBet')} es requerido`)
      .min(
        chance4DigitsSettingsLimits.minDigitsByBet,
        `${getChance4DigitsSettingsLabel('minDigitsByBet')} debe ser superior a ${
          chance4DigitsSettingsLimits.minDigitsByBet
        }`
      )
      .max(
        chance4DigitsSettingsLimits.maxDigitsByBet,
        `${getChance4DigitsSettingsLabel('minDigitsByBet')} apuesta debe ser inferior a ${
          chance4DigitsSettingsLimits.maxDigitsByBet
        }`
      )
      .test(
        ...
        `${getChance4DigitsSettingsLabel(
          'minDigitsByBet'
        )} debe ser menor que ${getChance4DigitsSettingsLabel('maxDigitsByBet')}`,
        function (value) {
    ...
    maxDigitsByBet: Yup.number()
      ...
      .min(
        chance4DigitsSettingsLimits.minDigitsByBet,
        `${getChance4DigitsSettingsLabel('maxDigitsByBet')} debe ser superior a ${
          chance4DigitsSettingsLimits.minDigitsByBet
        }`
      )
      .max(
        chance4DigitsSettingsLimits.maxDigitsByBet,
        `${getChance4DigitsSettingsLabel('maxDigitsByBet')} apuesta debe ser inferior a ${
          chance4DigitsSettingsLimits.maxDigitsByBet
        }`
      ),
    betReturnedRate2Digits: Yup.number()
      ...
      .min(
        ...
        `${getChance4DigitsSettingsLabel('betReturnedRate2Digits')} debe ser superior a ${
          chance4DigitsSettingsLimits.minBetReturnedRate2Digits
        }`
      )
      .max(
        chance4DigitsSettingsLimits.maxBetReturnedRate2Digits,
        `${getChance4DigitsSettingsLabel('betReturnedRate2Digits')} debe ser inferior a ${
          chance4DigitsSettingsLimits.maxBetReturnedRate2Digits
        }`
      ),
    betReturnedRate3Digits: Yup.number()
      ...
      .min(
        ...
        `${getChance4DigitsSettingsLabel('betReturnedRate3Digits')} debe ser superior a ${
          chance4DigitsSettingsLimits.minBetReturnedRate3Digits
        }`
      )
      .max(
        chance4DigitsSettingsLimits.maxBetReturnedRate3Digits,
        `${getChance4DigitsSettingsLabel('betReturnedRate3Digits')} debe ser inferior a ${
          chance4DigitsSettingsLimits.maxBetReturnedRate3Digits
        }`
      ),
    betReturnedRate4Digits: Yup.number()
      ...
      .min(
        ...
        `${getChance4DigitsSettingsLabel('betReturnedRate4Digits')} debe ser superior a ${
          chance4DigitsSettingsLimits.minBetReturnedRate4Digits
        }`
      )
      .max(
        chance4DigitsSettingsLimits.maxBetReturnedRate4Digits,
        `${getChance4DigitsSettingsLabel('betReturnedRate4Digits')} debe ser inferior a ${
          chance4DigitsSettingsLimits.maxBetReturnedRate4Digits
        }`
      ),
    maxBetByChance: Yup.number()
      ...
      .min(
        ...
        `${getChance4DigitsSettingsLabel('maxBetByChance')} debe ser superior a ${
          chance4DigitsSettingsLimits.minBetByChance
        }`
      )
      .max(
        chance4DigitsSettingsLimits.maxBetByChance,
        `${getChance4DigitsSettingsLabel('maxBetByChance')} debe ser inferior a ${
          chance4DigitsSettingsLimits.maxBetByChance
        }`
      ),
    maxOverallChanceBet: Yup.number()
      ...
      .min(
        ...
        `${getChance4DigitsSettingsLabel('maxOverallChanceBet')} debe ser superior a ${
          chance4DigitsSettingsLimits.minOverallChanceBet
        }`
      )
      .max(
        chance4DigitsSettingsLimits.maxOverallChanceBet,
        `${getChance4DigitsSettingsLabel('maxOverallChanceBet')} debe ser inferior a ${
          chance4DigitsSettingsLimits.maxOverallChanceBet
        }`
      ),
  })
